"""
Django settings for proyecto_inmuebles project.
...
SECRET_KEY = 'django-insecure-6_eervpcp#7g^tyr)y%#tn)w!ls$p%j*=rwxgnjgud_y5k3fka'
...
MEDIA_URL = '/media/'  # This is the URL path for serving media files
